          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <div className="space-y-2 text-[var(--text-muted)] text-sm">
              ...
              <p className="flex items-center gap-2">
                ...
                <a href={`https://wa.me/${CONTACT_WHATSAPP}`} target="_blank" rel="noopener noreferrer" className="hover:text-[var(--gold-500)] transition-colors" dir="ltr">{CONTACT_WHATSAPP}</a>
              </p>
