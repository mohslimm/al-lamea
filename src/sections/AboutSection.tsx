        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-24 items-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="text-[var(--text-muted)] text-lg leading-relaxed mb-6">
              AL LAMIAA is an integral part of the AL TARIQ AL LAMIAA GROUP, standing as a pillar of automotive excellence in Libya for over a decade. We specialize in the importation, local production, and exclusive distribution of premium automotive care products.
            </motion.p>
          ...
          >
            <img src="/about-image.png" alt="Automotive Care" className="w-full h-full object-cover opacity-80 mix-blend-lighten" />
          </motion.div>
        </div>
